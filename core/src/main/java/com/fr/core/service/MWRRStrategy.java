...
@Service
public class MWRRStrategy implements MergeStrategy{
	
	public static final Logger logger = Logger.getLogger(MWRRStrategy.class);
	...
	public ResponseVo getReportData(String filterParameter)  {
			...
			String url = APIUtils.formatUrl(webfocusUrl,paramsMap,String.valueOf(110));
			...
			List<Map<String,String>> dataList =  APIUtils.convertToJsonMap(responeToParse,cds.getFieldsList(110L, 380L));
