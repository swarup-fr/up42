...
public class SectorAllocationStrategy implements MergeStrategy{
	...
	public ResponseVo getReportData(String filterParameter)  {
			...
			String url = formatUrl(webfocusSaUrl,paramsMap);
			...
			List<Map<String,String>> dataList =  convertToJsonMap(responeToParse,cds.getFieldsList(108L, 354L));
