...
@Service
public class SectorAllocationStrategy implements MergeStrategy{
	...
	public ResponseVo getReportData(String filterParameter)  {
			...
			String url = APIUtils.formatUrl(webfocusSaUrl,paramsMap,String.valueOf(108));
			...
			List<Map<String,String>> dataList =  APIUtils.convertToJsonMap(responeToParse,cds.getFieldsList(108L, 354L));
