...
@Service
public class TransactionStrategy implements MergeStrategy{
	
	public static final Logger logger = Logger.getLogger(TransactionStrategy.class);
	...
	public ResponseVo getReportData(String filterParameter)  {
			...
			String url = APIUtils.formatUrl(webfocusUrl,paramsMap,String.valueOf(104));
			...
			try {
				...
				return buildErrorResponseVo("E1018 : Transaction RestClientException.");
			}catch(URISyntaxException e) {
				return buildErrorResponseVo("E1019 : Transaction URISyntaxException.");
			}
			
			List<Map<String,String>> dataList =  APIUtils.convertToJsonMap(responeToParse,cds.getFieldsList(104L, 373L));
